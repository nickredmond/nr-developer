...
function showConfirmationModal(title, contentText, buttonText, confirmationType) {
	document.getElementById("confirmation-modal-title").innerHTML = title;
	document.getElementById("confirmation-modal-text").innerHTML = contentText;
	document.getElementById("confirm-button").innerHTML = buttonText;
	document.getElementById("confirm-button").classList = "btn btn-" + confirmationType;
...
function onDeleteQuizClick() {
	refreshView();
	showConfirmationModal("Delete Quiz", 
